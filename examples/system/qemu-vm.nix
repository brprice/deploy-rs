# This is copied from https://github.com/NixOS/nixpkgs/pull/130383,
# and makes vmWithBootloader share the host nix db
# with a few tiny changes to make it work outside of the nixpkgs tree
...

{
  ...
  config = {
    ...
    boot.postBootCommands = if !cfg.useBootLoader then
      ''
    ...
    systemd.services = if cfg.useBootLoader then {
      nix-load-db = {
